...
#+RESULTS:
| osd \ (mds∪mon∪mgr) | 75 | =flush_store_cache=, =bluestore allocator fragmentation histogram bluefs-wal=, =dump_scrubs=, =bluestore allocator dump bluefs-wal=, =dump_objectstore_kv_stats=, =trim stale osdmaps=, =get_heap_property=, =scrub_purged_snaps=, =getomap=, =injectecclearwriteerr=, =debug dump_missing=, =bluefs stats=, =list_devices=, =dump_osd_pg_stats=, =dump_recovery_reservations=, =rmomapkey=, =setomapval=, =dump_op_pq_state=, =set_recovery_delay=, =dump_pool_statfs=, =scrubdebug=, =flush_pg_stats=, =dump_watchers=, =bluestore allocator fragmentation block=, =query=, =reset_pg_recovery_stats=, =get_latest_osdmap=, =bluestore allocator score block=, =dump_pgstate_history=, =setomapheader=, =set_heap_property=, =get_mapped_pools=, =injectecwriteerr=, =bluestore allocator score bluefs-wal=, =flush_journal=, =bench=, =bluestore bluefs device info=, =bluestore allocator dump block=, =bluestore allocator dump bluefs-db=, =bluestore allocator fragmentation bluefs-wal=, =injectecreaderr=, =schedule-scrub=, =clear_shards_repaired=, =bluestore allocator fragmentation histogram block=, =log=, =scrub=, =injectclearparityread=, =bluestore allocator score bluefs-db=, =injectdataerr=, =reset_purged_snaps_last=, =mark_unfound_lost=, =schedule-deep-scrub=, =bluestore collections=, =dump_blocklist=, =send_beacon=, =bluestore list=, =bluestore allocator fragmentation bluefs-db=, =dump_pg_recovery_stats=, =bluefs files list=, =injectfull=, =calc_objectstore_db_histogram=, =list_unfound=, =bluestore compression stats=, =rotate-stored-key=, =bluestore allocator fragmentation histogram bluefs-db=, =injectmdataerr=, =cluster_log=, =deep-scrub=, =bluefs debug_inject_read_zeros=, =truncobj=, =debug kick_recovery_wq=, =injectecclearreaderr=, =dump_scrub_reservations=, =injectparityread=, =bluestore onode metadata= |
| mds \ (osd∪mon∪mgr) | 43 | =get subtrees=, =flush_path=, =dirfrag merge=, =dump inode=, =flush journal=, =op kill=, =session ls=, =session evict=, =quiesce path=, =session config=, =respawn=, =lockup=, =scrub abort=, =dirfrag split=, =scrub purge_status=, =export dir=, =osdmap barrier=, =quiesce db=, =lock path=, =dump snaps=, =dump loads=, =session kill=, =force_readonly=, =damage rm=, =damage ls=, =scrub status=, =op get=, =dump dir=, =client evict=, =scrub resume=, =tag path=, =exit=, =dump stray=, =dirfrag ls=, =dump cache=, =scrub_path=, =client config=, =dump tree=, =client ls=, =openfiles ls=, =scrub pause=, =dump_export_states=, =scrub start=                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| mon \ (mds∪osd∪mgr) |  9 | =connection scores dump=, =mon_status=, =sessions=, =add_bootstrap_peer_hint=, =quorum exit=, =add_bootstrap_peer_hintv=, =quorum enter=, =connection scores reset=, =sync_force=                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| mgr \ (mds∪osd∪mon) |  1 | =mgr_status=                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
